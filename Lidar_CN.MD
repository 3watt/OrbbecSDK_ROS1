...
```bash
# 假设您已经配置了 ROS 环境
sudo apt install libgflags-dev nlohmann-json3-dev libdw-dev libdwarf-dev libelf-dev
```
ubuntu 20 之前的版本需要安装 `nlohmann-json-dev`。
...
![PointCloud2可视化示例](docs/images/lidar0.png)

* `LaserScan` 可视化示例：

![LaserScan可视化示例](docs/images/lidar1.png)
